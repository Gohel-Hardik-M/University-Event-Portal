...
<?php $__env->startSection('content'); ?>
  <main class="register-container">
    <div class="register-box">
      <h1>Register</h1>
      <form action="<?php echo e(URL::to('/')); ?>/register_action" method="POST">
        <?php echo csrf_field(); ?>
      ...
      <p>Already have an account? <a href="<?php echo e(URL::to('/')); ?>/login">Login</a></p>
    </div>
  </main>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel Projects\unigram\resources\views/register.blade.php ENDPATH**/ ?>