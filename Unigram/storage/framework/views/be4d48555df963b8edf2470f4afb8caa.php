        ...
        <tbody>
          ...
          <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <tr>
            ...
            <td><?php echo e($post->post_type); ?></td>
            <td><?php echo e($post->title); ?></td>
            <th><form action="" method="POST">
              <?php echo csrf_field(); ?>
                 <input name='id' value="<?php echo e($post->id); ?>" hidden/>  
                 <input name='snapchat_username' value="<?php echo e($post->title); ?>" hidden/>            
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel Projects\unigram\resources\views/admin_university_view.blade.php ENDPATH**/ ?>